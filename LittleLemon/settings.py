...
SECRET_KEY = "django-insecure-eq(qm@)q05wn*e_7w%hf5n_=36o3my2xlo+qne-3i@56y$giy5"
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {'anon':'2/min','user':'10/min'},
}
...
DJOSER = {
    ...
    'SERIALIZERS': {
         #other serializers
         'activation': 'LittleLemonAPI.serializers.MyActivationSerializer',
         #other serializers
    }
}